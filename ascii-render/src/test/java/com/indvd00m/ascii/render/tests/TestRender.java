...
public class TestRender {
	...
	public void test() {
		...
		layer2.addElement(new Rectangle(22, 2, 16, 16));
		...
		layer3.addElement(new Rectangle(0, 0, layer3.getRegion().getWidth() - 1, layer3.getRegion().getHeight() - 1));
		...
		layer4.addElement(new Rectangle(0, 0, layer4.getRegion().getWidth() - 1, layer4.getRegion().getHeight() - 1));
		...
		layer5.addElement(new Rectangle(0, 0, layer5.getRegion().getWidth() - 1, layer5.getRegion().getHeight() - 1));
		...
		layer6.addElement(new Rectangle(0, 0, layer6.getRegion().getWidth() - 1, layer6.getRegion().getHeight() - 1));
		...
		layer7.addElement(new Rectangle(0, 0, layer7.getRegion().getWidth() - 1, layer7.getRegion().getHeight() - 1));
		...
		for (int i = 0; i < 5; i++) {
			...
			layer.addElement(new Rectangle(0, 0, layer.getRegion().getWidth() - 1, layer.getRegion().getHeight() - 1));
		}
